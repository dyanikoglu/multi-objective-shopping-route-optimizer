        ...
        generateSimpleCart = function (space) {
            ...
            simpleCart.extend({
                ...
                rst: function () {
                    ...
                    simpleCart.each(function (item) {
                        ...
                        // from being removed
                        if (item.remove(true, true) === false) {
                ...
                logged_user: function () {
                    user = localStorage.getItem(namespace + "_logged_user");
            ...
            simpleCart.extend({
                ...
                logged: function (user) {
                    localStorage.setItem(namespace + "_logged_user", JSON.stringify(user));
                }
                ...
                me.equals = function (item) {
                    for (var label in _data) {
                        if (Object.prototype.hasOwnProperty.call(_data, label)) {
                            if (label !== 'quantity' && label !== 'id' && label !== 'itemid' && label !== 'addedby') {
            ...
            simpleCart.Item._ = simpleCart.Item.prototype = {
                ...
                remove: function (skipUpdate, skipEvent) {
                    if (!skipEvent) {
